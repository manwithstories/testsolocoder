  ...
  <MainLayout>
    <div class="page-container">
      <div class="page-header">
        <div class="page-title">编辑职位</div>
      </div>

      <el-card v-loading="loading">
        <el-form v-if="job" :model="form" :rules="rules" ref="formRef" label-width="120px" class="form-container">
  ...
  try {
    ...
    if (res.data) {
      ...
      Object.assign(form, {
        ...
        salary_type: res.data.salary_type || 'monthly',
